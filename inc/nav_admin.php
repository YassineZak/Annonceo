...
<div id="depotAnnonce">
  ...
  <input type="text" placeholder="Titre de l'annonce" name="titre" value="" class="form-control">
  ...
  <select name="categorie" class="taskOption form-control">
  ...
  <input id="user_input_autocomplete_address" name="adresse" placeholder="Saisissez votre adresse complete" class="taskOption form-control"></input>
...
<header>
  ...
  <nav>
    ...
    <div class="col-lg-5">
      <div class="input-group">
        <form class="input-group" class="" action="index.php" method="get">
...
<div id="admin" class="dropdown-menu">
  <a class="dropdown-item " href="profil.php">votre profil</a>
  <a class="dropdown-item " href="annonce.php">Gestion des annonces</a>
  <a class="dropdown-item " href="membre.php">Gestion des membres</a>
  <a class="dropdown-item " href="commentaire.php">Gestion des commentaires</a>
  <a class="dropdown-item " href="gestion_note.php">Gestion des notes</a>
  <a class="dropdown-item " href="top_membre.php">Statistiques</a>
